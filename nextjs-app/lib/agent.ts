import { AgentStatusType, AgentResponse } from "@/types/agent";
import { generateAgentResponse, processHumanApproval } from "./gemini";
import { queryRag } from "./rag";

declare global {
  var tacitAgent: TacitAgent | undefined;
}
...
export const tacitAgent = globalThis.tacitAgent || new TacitAgent();
if (process.env.NODE_ENV !== 'production') {
  globalThis.tacitAgent = tacitAgent;
}
