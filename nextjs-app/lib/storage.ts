import { Session, InsertSession, Message, InsertMessage } from "@/types/agent";
...
declare global {
  var storage: MemStorage | undefined;
}

export const storage = globalThis.storage || new MemStorage();
